<h2><a href="https://leetcode.com/problems/partial-function-with-placeholders/">2797. Partial Function with Placeholders</a></h2><h3>Easy</h3><hr><div><p>Given a function <code>fn</code>&nbsp;and an array <code>args</code>, return a function <code>partialFn</code>.&nbsp;</p>
...
<pre><strong>Input:</strong> fn = (...args) =&gt; args, args = [2,4,6], restArgs = [8,10]
...
<pre><strong>Input:</strong> fn = (...args) =&gt; args, args = [1,2,"_",4,"_",6], restArgs = [3,5]
...
<pre><strong>Input:</strong> fn = (a, b, c) =&gt; b + a - c, args = ["_", 5], restArgs = [5, 20]
